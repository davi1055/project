...
: ${AMENT_CURRENT_PREFIX:="/root/my_ros_bot/workspace/install/robot_describtion"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_describtion/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_describtion/environment/path.sh"
