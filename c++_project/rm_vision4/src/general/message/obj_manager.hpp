...
#ifndef GENERAL_MESSAGE_OBJ_MANAGER_HPP_
#define GENERAL_MESSAGE_OBJ_MANAGER_HPP_
...
template <class T>
__attribute__((visibility("default"))) inline std::unordered_map<std::string, typename ObjManager<T>::wptr> ObjManager<T>::_map;
...
#endif //! GENERAL_MESSAGE_OBJ_MANAGER_HPP_